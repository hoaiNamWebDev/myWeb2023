            ...
            case 'sanpham':
                ...
                case 'tintucct':
                    if(isset($_GET['idtt']) && ($_GET['idtt']>0)){
                        ...
                        switch ($id) {          
                            case '1':
                                $doc= "https://drive.google.com/file/d/1VsV6Y7sH11GbUbbEDmKKu8Envgb_uwCh/preview#toolbar=0&navpanes=0";
                                $tenDoc= "Phần mềm giải bài toán Balo - Java";
                                break;
                            case '2':  
                                $doc= "https://drive.google.com/file/d/13NXLumKiPq4msR_aSIRYrx5iZ3-h2_4k/preview#toolbar=0";
                                $tenDoc= "Mô phỏng lây bênh muỗi sốt xuất huyết - Gama(gaml)";
                                break;                                        
                            case '3':
                                $doc= "https://drive.google.com/file/d/1BJPpOOlYIQwjypgDhluPxvcjqk5w9xXB/preview#toolbar=0";
                                $tenDoc= "Phần mềm website bán sách - PHP";
                                break;
                            case '4':  
                                $doc= "https://drive.google.com/file/d/1o29AWwkptT5eHalHi3mr4XeyMMeCZCQk/preview#toolbar=0";
                                $tenDoc= "Bài tập hệ quản trị CSDL - Oracle";
                                break;
